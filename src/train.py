...
from dataset.audio_dataset import (MalayAudioDataset,
                                   AudioProcessor,
...
from utils.argument_classes import ModelArguments, DataTrainingArguments
...
def main():
    ...
    wandb.init(project="src", config=wandb.config)
    ...
    # Set seed before initializing pretrained_models.
    ...
    # Load pretrained pretrained_models and tokenizer
    # Distributed training:
    # The .from_pretrained methods guarantee that only one local process can concurrently
    # download pretrained_models & vocab.
    ...
    log_timestamp("load pretrained_models")
    # Metric
    ...
    if training_args.do_train:
        ...
        log_timestamp("train pretrained_models")
        trainer.save_model()
    ...
    # save pretrained_models files
    artifact = wandb.Artifact(
        name=f"pretrained_models-{wandb.run.id}", type="pretrained_models", metadata={"cer": test_cer}
    )

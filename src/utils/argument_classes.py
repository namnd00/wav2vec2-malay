...
class ModelArguments:
    """
    Arguments pertaining to which pretrained_models/config/tokenizer we are going to fine-tune from.
    """

    model_name_or_path: str = field(
        metadata={
            "help": "Path to pretrained pretrained_models or pretrained_models identifier from huggingface.co/models"
        }
    )
    ...
    freeze_feature_extractor: Optional[bool] = field(
        default=True,
        metadata={
            "help": "Whether to freeze the feature extractor layers of the pretrained_models."
        },
    )
...
class DataTrainingArguments:
    """
    Arguments pertaining to what data we are going to input our pretrained_models for training and eval.

...
#         100 * wer.compute(predictions=result["pred_strings_with_ctc"], references=result["sentence"])))
#     print("WER with CTC+LM: {:2f}".format(
#         100 * wer.compute(predictions=result["pred_strings_with_lm"], references=result["sentence"])))
#
#
